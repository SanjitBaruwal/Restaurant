    ...
    <div className="  w-full bg-[#F9FAFD]  ">
      <div className=" py-[110px] relative " id="contact">
        ...
        <div className=" relative mt-20 px-10 lg:px-[5%] xl:px-[12.5%] grid xs:grid-cols-1 lg:grid-cols-3 gap-4 z-10 ">
          ...
          <div
            className="bg-white h-[232px] flex  justify-start xs:pl-5 sm:pl-20 lg:pl-10 items-center rounded-lg relative  "
            style={{ boxShadow: `0px 0px 15px 5px rgba(0,0,0,0.1)` }}
          >
            ...
            <motion.div
              ...
              variants={kisspng}
              className="absolute right-0 top-0 h-[40%] aspect-square rounded-lg z-[0] overflow-hidden "
            >
              <img
                src="/kisspng-soup.png"
                alt="kisspng"
